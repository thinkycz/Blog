...
class ImageRepositoryTest extends ApplicationTestCase
{
	protected function _getRepo() {
		return $this->container->get('cvut_fit_biwt1_blog_common.repository.image');
	}
	...
	protected function _create() {
		...
		$object = new Image;
		$object->setName('Image 1');
		$object->setData('dummy data');
		$object->setCreated($now);
		$object->setInternetMediaType('application/octet-stream');
		$object->setDimensionX(320);
		$object->setDimensionY(240);
		$object->setPreview('dummy preview');
